...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-8 shadow-sm space-y-6">
        <div>
            <span class="px-3 py-1 rounded-lg text-xs font-bold uppercase bg-blue-100 text-blue-700">
        ...
        <div class="p-4 rounded-2xl bg-slate-50 border border-slate-100 space-y-2 text-xs">
            ...
            <div class="pt-2 border-t border-slate-200/60">
                ...
                <p class="font-extrabold text-blue-900 text-sm mt-0.5">{{ $periodeAktif->nama_periode }}</p>
        ...
        <form action="{{ route('yudisium.daftar.store') }}" method="POST" class="space-y-4">
            ...
            <div class="p-4 rounded-2xl bg-blue-50 border border-blue-200 text-xs text-blue-950 space-y-1.5">
                <strong class="font-bold block"><i class="fa-solid fa-circle-info mr-1 text-blue-600"></i> Persyaratan Dokumen Bebas Tanggungan:</strong>
